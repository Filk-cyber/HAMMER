...
for i in {0..10}; do
    ...
    test_file="${BASE_DATA_DIR}/hotpotqa_dev100ideal_with_reasoning_chains_modify_${weight_str}.json"
    ...
    # 生成日志文件名
    log_file="${log_dir}/evaluation_trace_tripledev100ideal_log_${timestamp}.log"
