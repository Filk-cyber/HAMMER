...
for i in {0..10}; do
    ...
    # 生成输出和日志文件名
    output_file="${BASE_DATA_DIR}/musique_dev100ideal_with_reasoning_chains_modify_${weight_str}.json"
    log_file="${log_dir}/musique_construct_reasoning_chains_modify_log100_${timestamp}.log"
    ...
    python construct_reasoning_chains_modify.py \
      --dataset musique \
      --input_data_file "${BASE_DATA_DIR}/musique_dev100_add_truthful_scores_with_kgs_final.json" \
