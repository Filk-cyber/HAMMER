...
"""
    ...
    def process_dataset_optimized(self, input_file: str, output_file: str, text_batch_size: int = 5,
                                  triple_batch_size: int = 5, retry_only: bool = False,
...
def main():
    ...
    INPUT_FILE = "/home/jiangjp/trace-idea/data/2wikimultihopqa/wiki_test1000_add_truthful_scores_with_kgs_final.json"
    OUTPUT_FILE = "/home/jiangjp/trace-idea/data/2wikimultihopqa/wiki_test1000_add_truthful_scores_with_kgs_final2.json"

    # 并行处理参数
    MAX_WORKERS = 3000  # 并发线程数，根据API限制调整
    TEXT_BATCH_SIZE = 1  # 文本处理批次大小
    TRIPLE_BATCH_SIZE = 1  # 三元组处理批次大小
